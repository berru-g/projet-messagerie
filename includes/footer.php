  ...
  FileShare
    ...
    <div class="footer-features">
      ...
      <ul>
        ...
        <li><i class="fas fa-file-pdf"></i><a href="../pages/gallery.php"> Excel & Csv to Chart</a></li><!--attention tout les json ne se mette pas en tableau et le telechargement est uniquement en json, non en pdf pour l'instant-->
        ...
        <li><i class="fas fa-project-diagram"></i><a href="../pages/json-to-map.php"> Json Editor to Mind Map</a></li>
        <li><i class="fas fa-database"></i><a href="../pages/SQL-editor.php"> SQL Editor to Mind Map</a></li>
        <li><i class="fa-solid fa-comment-nodes"></i><a href="/SQL-builder-NoCode/index.html"> SQL Builder No Code</a></li>
        <li><i class="fas fa-code"></i><a href="../pages/codepen.php"> Live front code editor</a></li>
